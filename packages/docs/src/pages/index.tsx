...
export const actions = [
  {
    title: 'What is Marginly',
    icon: Info,
    to: '/docs/concepts/overview',
    text: `Learn about the core concepts of the Marginly Protocol, Swaps, Pools, Concentrated Liquidity and more.`,
  },
  {
    title: 'Integrate with Marginly',
    icon: HelpCircle,
    to: '/sdk/v3/overview',
    text: `Learn how to integrate with Marginly by building a dApp through guided examples.`,
  },
  {
    title: 'The Marginly smart contracts',
    icon: BookOpen,
    to: '/docs/contracts/overview',
    text: `Learn about the architecture of the Marginly Protocol smart contracts through guided examples.`,
  },
];
...
export default function Home() {
  return (
    <Layout title={`Marginly Docs`} description="Technical Documentation For The Marginly Protocol">
      <Container>
        <DocsHeader>
          <div
            style={{
          ...
          >
            <h1 style={{ fontWeight: 600 }}> Welcome to Marginly Docs</h1>
          </div>
          <StyledTitleImage
            sources={{
        ...
        >
          <div>
            ...
            <p>Explore these guided tutorials to get started integrating with Marginly in your dApp.</p>
            <div>
          ...
          <div>
            ...
            <p>Explore these guided tutorials to get started integrating with Marginly in your smart contracts.</p>
            <div>
        ...
        <Row>
          ...
          <Link style={{ textDecoration: 'none' }} href={'https://github.com/Uniswap'}>
            <CenterCard>
              ...
              <div>
                <h3>GitHub</h3>
                <p>View all Marginly repositories.</p>
              </div>
            </CenterCard>
          </Link>
        </Row>
