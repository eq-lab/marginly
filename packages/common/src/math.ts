...
export function twapFromTickCumulatives([tickCumulative0, tickCumulative1]: [bigint, bigint], [secondsAgo0, secondsAgo1]: [bigint, bigint], tokenDecimals0: number, tokenDecimals1: number): number {
...
export function sortUniswapPoolTokens<T>([tokenAAddress, tokenBAddress]: [`0x${string}`, `0x${string}`], [tokenA, tokenB]: [T, T]): [T, T] {
