...
export async function deleveragePrecisionLong(sut: SystemUnderTest) {
  ...
  for(let i = 0; i < 10; ++i) {
    ...
    // console.log(await marginlyPool.baseCollateralDelevCoeff());
    // console.log(await marginlyPool.quoteDebtDelevCoeff());
    // console.log(await marginlyPool.quoteCollateralDelevCoeff());
    // console.log(await marginlyPool.baseDebtDelevCoeff());
    ...
    logger.info(`  quoteCollateralDelevCoeffAfter = ${quoteCollateralDelevCoeffAfter}`);
    logger.info(`  baseDebtDelevCoeffAfter = ${baseDebtDelevCoeffAfter}`);
