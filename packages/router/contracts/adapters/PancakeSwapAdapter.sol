...
contract PancakeSwapAdapter is AdapterStorage, UniswapV2LikeSwap {
  ...
  function swapExactInput(
    ...
    amountOut = uniswapV2LikeGetAmountOut(pool, amountIn, tokenIn, tokenOut, PANCAKE_SWAP_FEE);
  ...
  function swapExactOutput(
    ...
    address pool = getPoolSafe(tokenIn, tokenOut);
    amountIn = uniswapV2LikeGetAmountIn(pool, amountOut, tokenIn, tokenOut, PANCAKE_SWAP_FEE);
