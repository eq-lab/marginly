...
describe('MarginlyRouter UniswapV2', () => {
  ...
  it('swapExactInput 0 to 1, less than minimal amount', async () => {
    ...
    expect(
      marginlyRouter
        .connect(user)
        .swapExactInput(1, token0.address, token1.address, amountToSwap, amountToGet.add(1))
    ).to.be.revertedWith('Insufficient amount');
  });
  ...
  it('swapExactInput 1 to 0, less than minimal amount', async () => {
    ...
    expect(
      marginlyRouter
        .connect(user)
        .swapExactInput(1, token1.address, token0.address, amountToSwap, amountToGet.add(1))
    ).to.be.revertedWith('Insufficient amount');
  });
  ...
  it('swapExactOutput 0 to 1, success', async () => {
    ...
    await marginlyRouter
      .connect(user)
      .swapExactOutput(1, token0.address, token1.address, initialAmount0, amountToGet);
  ...
  it('swapExactOutput 0 to 1, more than maximal amount', async () => {
    ...
    expect(
      marginlyRouter
        .connect(user)
        .swapExactOutput(1, token0.address, token1.address, amountToSwap.sub(1), amountToGet)
    ).to.be.revertedWith('Too much requested');
  });
  ...
  it('swapExactOutput 1 to 0, success', async () => {
    ...
    await marginlyRouter
      .connect(user)
      .swapExactOutput(1, token1.address, token0.address, initialAmount1, amountToGet);
  ...
  it('swapExactOutput 1 to 0, more than maximal amount', async () => {
    ...
    expect(
      marginlyRouter
        .connect(user)
        .swapExactOutput(1, token1.address, token0.address, amountToSwap.add(1), amountToGet)
    ).to.be.revertedWith('Too much requested');
  });
});
